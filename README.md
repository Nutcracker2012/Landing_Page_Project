...
This project is the second project for udacity front-end nano degree course
## Table of Contents
...
## How to use
- Download or clone via https://github.com/Nutcracker2012/Landing_Page_Project.git
- Open index.html in current web browser

## Project Screenshots
### App Home page
![App screenshot](img/Screen_1.png)
### App Smooth scroll to another section
![App screenshot](img/Screen_2.png)
